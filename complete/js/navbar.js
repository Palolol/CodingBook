...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const searchableItems = [
        ...
        { title: 'UX/UI',    url: '/tutorials/UX-UI.html',    icon: 'fa-database',        category: 'uxui',       tags: 'ux/ui is a design' },
        { title: 'UX/UI Copy',    url: '/tutorials/UX-UI_copy.html',    icon: 'fa-database',        category: 'uxui',       tags: 'ux/ui is a design' },
        { title: 'UX/UI 2', url: '/tutorials/UX-UI2.html',    icon: 'fa-database',        category: 'uxui',       tags: 'ux/ui is a design' },
